...
class ReportViewController : BaseViewController, FormResult {
    ...
    @IBAction func moreInformationAction(_ sender: Any) {
        let reportAdvancedViewController = Router.ReportAdvancedViewController() as! ReportAdvancedViewController
        reportAdvancedViewController.delegate = self
        reportAdvancedViewController.questions = [
            Question(
        ...
        navigationController?.pushViewController(reportAdvancedViewController, animated: true)
    }
